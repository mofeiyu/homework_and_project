...
print("sample attributes normalization: avg_trans({0}), avg_payment({1}), avg_silver({2}), "
      "sex({3})".format(None, sample_normal_avg_payment, sample_normal_avg_silver, sample_sex))
print("******************************************************************"*2+"\n")
...
for i in range(len(sex)):
    overall_distance.append(np.sqrt(distance_in_avg_payment[i] + distance_in_avg_silver[i] + distance_in_sex[i]))
